...
export default function RegisterPage() {
  ...
  const [redirect, setRedirect] = useState(""); // Store the redirect URL
  ...
  async function registerUser(ev) {
    ...
    try {
      await axios.post("/register", {
        ...
        email,
        password,
        role, // Include the role in the registration request
      });
      alert("Registration Successful");
      setRedirect(role); // Set redirect based on role
    } catch (e) {
