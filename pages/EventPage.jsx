...
// Optional: replace this with your actual user context or props
const mockUser = {
  role: "admin", // change this to 'user' for non-admins
};
        ...
        <div className="flex flex-col md:flex-row gap-2">
          {mockUser.role === "admin" && (
            <>
              ...
              <button
                onClick={deleteEvent}
                className="bg-red-600 text-white px-4 py-2 h-10 rounded hover:bg-red-700"
              >
                Delete Event
              </button>
            </>
